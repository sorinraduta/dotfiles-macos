...
```
   ...
   - `new-tab/.config/new-tab` to `~/.config/new-tab`
...
4. **Load the Chrome extension:**
   ...
   - Click **Load unpacked** and select `~/.config/new-tab`
   - Chrome will now use your custom page on every new tab
...
- Custom Chrome new tab page loaded as a local unpacked extension.
...
| **New tab** | Custom Chrome extension that replaces the new tab page with a local `index.html` |